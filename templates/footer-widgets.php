...
$footer_logo_img 	= wp_get_attachment_image_src( $footer_logo_img_id, 'conbusi_footer_logo_166x45' )[0];
$footer_text 	    = conbusi_opt( 'conbusi_footer_text' );
$site_url 	    	= home_url('/');
		?>
				...
				<?php
					echo '<div class="footer_logo">';
						if ( $footer_logo_img ) {
							...
							?>
							<a href="<?=esc_url($site_url)?>"><img src="<?=esc_url( CONBUSI_DIR_IMGS_URI . 'footer_logo.png' )?>" alt="footer logo"></a>
							<?php
						}
					echo '</div>';
					...
					// Social profiles
					$social_opt = conbusi_opt('conbusi_social_profile_toggle');
					if ( $social_opt == true ) {
						$social_items = conbusi_opt('conbusi_social_profiles');
