...
// image default alt
if ( ! function_exists( 'conbusi_img_default_alt' ) ) {
	function conbusi_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'conbusi_img_tag' ) ) {
	function conbusi_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = conbusi_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'conbusi_anchor_tag' ) ) {
	function conbusi_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'conbusi_heading_tag' ) ) {
	function conbusi_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'conbusi_paragraph_tag' ) ) {
	function conbusi_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'conbusi_other_tag' ) ) {
	function conbusi_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'conbusi_button_element ' ) ) {
	function conbusi_button_element( array $args ) {
