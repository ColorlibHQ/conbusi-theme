...
function conbusi_widgets_init() {
    // sidebar widgets register
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar', 'conbusi' ),
        'id'            => 'conbusi-post-sidebar',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Two', 'conbusi' ),
        'id'            => 'footer-2',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Three', 'conbusi' ),
        'id'            => 'footer-3',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Four', 'conbusi' ),
        'id'            => 'footer-4',
...
add_action( 'widgets_init', 'conbusi_widgets_init' );
