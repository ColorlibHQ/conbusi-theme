...
// enqueue css
function conbusi_common_custom_css(){
    
    wp_enqueue_style( 'conbusi-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= conbusi_opt( 'conbusi_theme_color' ) != '#131313' ? conbusi_opt( 'conbusi_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= conbusi_opt( 'conbusi_book_btn_color' ) != '#131313' ? conbusi_opt('conbusi_book_btn_color') : '';
		$bookBtnHoverBgColor     	= conbusi_opt( 'conbusi_book_btn_hvr_bg_color' ) != '#131313' ? conbusi_opt('conbusi_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = conbusi_opt( 'conbusi_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = conbusi_opt( 'conbusi_navbar_bg_color' ) != '#082b49' ? conbusi_opt( 'conbusi_navbar_bg_color') : '';
		$headerTop_col     		  = conbusi_opt( 'conbusi_top_header_color' );

		$headerTopBg      		  = conbusi_opt( 'conbusi_top_header_bg_color');
		$headerBg          		  = conbusi_opt( 'conbusi_header_bg_color') != '#ffffff' ? conbusi_opt( 'conbusi_header_bg_color') : '';
		$menuColor          	  = conbusi_opt( 'conbusi_header_menu_color' ) != '#131313' ? conbusi_opt('conbusi_header_menu_color') : '';
		$menuHoverColor           = conbusi_opt( 'conbusi_header_menu_hover_color' ) != '#808080' ? conbusi_opt('conbusi_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = conbusi_opt( 'conbusi_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = conbusi_opt( 'conbusi_header_drop_menu_bg_color' ) != '#ffffff' ? conbusi_opt('conbusi_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = conbusi_opt( 'conbusi_dropdown_menu_color' ) != '#131313' ? conbusi_opt('conbusi_dropdown_menu_color') : '';
		$dropMenuHovColor         = conbusi_opt( 'conbusi_dropdown_menu_hover_color' ) != '#808080' ? conbusi_opt('conbusi_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = conbusi_opt( 'conbusi_footer_widget_bg_color' );
		$footerwHeadColor   	  = conbusi_opt('conbusi_footer_widget_heading_color');
		$footerwTextColor   	  = conbusi_opt('conbusi_footer_widget_text_color');
		$footerwanchorcolor 	  = conbusi_opt('conbusi_footer_widget_anchor_color') != '#ffffff' ? conbusi_opt('conbusi_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = conbusi_opt('conbusi_footer_widget_anchor_hover_color') != '#ffffff' ? conbusi_opt('conbusi_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = conbusi_opt('conbusi_fof_bg_color');
		$foftonecolor			  = conbusi_opt('conbusi_fof_textone_color');
		$fofttwocolor			  = conbusi_opt('conbusi_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = conbusi_opt('conbusi_footer_widget_anchor_color') != '#9e9e9e' ? conbusi_opt('conbusi_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .conbusi_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .conbusi_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'conbusi-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'conbusi_common_custom_css', 50 );